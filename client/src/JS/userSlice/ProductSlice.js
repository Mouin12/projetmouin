...
export const userRegister = createAsyncThunk("product/register", async (user) => {
  try {
    let response = await axios.post(
      "http://localhost:5000/product/register",
      user
    );
...
export const userLogin = createAsyncThunk("product/login", async (user) => {
  try {
